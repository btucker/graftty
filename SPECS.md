...
**TEAM-10.9** When Graftty upgrades a legacy managed Codex home, the application shall migrate real non-generated state entries into the durable Codex home before replacing them with symlinks.
