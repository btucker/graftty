...
struct TeamEventLogTests {
    ...
    @Test("agentStateTransition and codexAppServerDeliveryAttempt encode to JSON with stable shape.")
    func newEventKindsEncode() throws {
        ...
        try log.append(TeamEvent(
            ...
            detail: ["worktree": "/r/alice", "runtime": "codex", "outcome": "sent", "messageIDs": "id-1,id-2", "threadID": "thread-123"],
        ...
        #expect(text.contains("\"kind\":\"codexAppServerDeliveryAttempt\""))
    }
