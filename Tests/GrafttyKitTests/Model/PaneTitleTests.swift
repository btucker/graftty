...
struct PaneTitleEnvAssignmentTests {
    ...
    func keepsLowercaseTitles() {
        #expect(!PaneTitle.isLikelyEnvAssignment("graftty"))
...
struct PaneTitleBasenameTests {
    ...
    @Test func returnsDirectoryBasename() {
        #expect(PaneTitle.basenameLabel(pwd: "/Users/btucker/projects/graftty") == "graftty")
        #expect(PaneTitle.basenameLabel(pwd: "/Users/btucker/projects/graftty/Sources") == "Sources")
    }
...
struct PaneTitleDisplayTests {
    ...
    func fallsBackToPWDBasename() {
        #expect(PaneTitle.display(storedTitle: nil, pwd: "/Users/btucker/projects/graftty") == "graftty")
        #expect(PaneTitle.display(storedTitle: "", pwd: "/Users/btucker/projects/graftty") == "graftty")
    }
