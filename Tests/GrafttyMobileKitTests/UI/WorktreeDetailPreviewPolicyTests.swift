...
struct WorktreeDetailSinglePaneTests {
    ...
    func leafIsRecognizedAsSinglePane() {
        #expect(PaneLayoutNode.leaf(sessionName: "only", title: "Only", attentionText: nil, isBusy: false).isLeaf)
    }
    ...
    func splitIsNotASinglePane() {
        let layout = PaneLayoutNode.split(
            ...
            right: .leaf(sessionName: "right", title: "Right", attentionText: nil, isBusy: false)
        )
