...
""")
    func fontSizeTracksTileWidthAndAuthoritativeColumns() {
        let portrait = PanePreviewFontSizing.fontSize(tileWidth: 240, authoritativeCols: 120)
        let landscape = PanePreviewFontSizing.fontSize(tileWidth: 480, authoritativeCols: 120)
        let narrowerGrid = PanePreviewFontSizing.fontSize(tileWidth: 240, authoritativeCols: 80)
    ...
    func fontSizeFallsBackToEightyColumnsAndMinimumSize() {
        #expect(PanePreviewFontSizing.fontSize(tileWidth: 240, authoritativeCols: nil) == 4.75)
        #expect(PanePreviewFontSizing.fontSize(tileWidth: 0, authoritativeCols: 120) == 2)
        #expect(PanePreviewFontSizing.fontSize(tileWidth: 12, authoritativeCols: 120) == 2)
    }
}
