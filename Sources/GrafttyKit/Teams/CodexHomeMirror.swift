...
public struct CodexHomeMirror: Sendable {
    ...
    public let grafttyHooksEnabled: Bool

    public init(
        sourceDirectory: URL,
        mirrorDirectory: URL,
        grafttyCLIPath: String,
        grafttyHooksEnabled: Bool = true
    ) {
        self.sourceDirectory = sourceDirectory
        self.mirrorDirectory = mirrorDirectory
        self.grafttyCLIPath = grafttyCLIPath
        self.grafttyHooksEnabled = grafttyHooksEnabled
    }
    ...
    private func writeMergedHooks() throws {
        ...
        for event in TeamHookEvent.allCases {
            ...
            let legacyWrapperEvent = event == .sessionStart
                || event == .preToolUse
                || event == .permissionRequest
            hooks[key] = grafttyHooksEnabled && legacyWrapperEvent
    ...
    private func grafttyMatcherGroup(event: TeamHookEvent) -> [String: Any] {
        ...
        if event == .preToolUse {
            group["matcher"] = "AskUserQuestion|ExitPlanMode|request_user_input|exit_plan_mode"
        }
        return group
    }
